...
if __name__ == "__main__":
    ...
    xgb_group.add_argument('--xgb_conf', default="xgb-conf.json",
                           help='Path to XGB parameters JSON dictionary.  See week1/conf/xgb-conf.json')
    xgb_group.add_argument('--xgb_feat_map', default="xgb-feat-map.txt",
                           help='File name under --output_dir containing the feature map.  Must be set when creating training data.  See week1/conf/xgb-feat-map.txt')
    ...
    click_group.add_argument("--click_model", choices=["ctr", "binary", "beta", "quantiles", "beta_quantiles", "heuristic"], default="ctr",
