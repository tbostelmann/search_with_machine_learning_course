...
class DataPrepper:
    ...
    def log_features(self, train_data_df, terms_field="_id", feature_names=[]):
        feature_frames = []
        ...
        for key in query_gb.groups.keys():
            ...
            ltr_feats_df = self.__log_ltr_query_features(group[:1]["query_id"], key, doc_ids, click_prior_query, no_results,
                                                         terms_field=terms_field, feature_names=feature_names)
    ...
    def __log_ltr_query_features(self, query_id, key, query_doc_ids, click_prior_query, no_results, terms_field="_id", feature_names=[]):
        ...
        for feature_name in feature_names:
            data_frame_astype[feature_name] = 'float'
        return frame.astype(data_frame_astype)
